...
- Thread 08 follow-up reused `query-service.ts` normalization and serialization helpers so assistant filter links match the existing list-page query contracts instead of hand-built query strings.
