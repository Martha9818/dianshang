...
| Electron production CSP and navigation policy | OPEN | High | POC loads local Next dev and shows a development CSP warning; V2 must serve production assets with strict CSP and audited external-link handling. |
